...
\begin{algorithm}[hbt!]
	...
	\While{$\lvert \mathbf{X} \rvert >  p$}{
		...
		$\mathbf{T} \gets \mathbf{X} \cup \{ G_1^* \cup  G_2^* \}$\Comment*[r]{Add union to secondary storage for traceability}
	}
\end{algorithm}
...
\section{Parameter Choice and Performance Comparison}
\newpage
%========= Appendix ==========
